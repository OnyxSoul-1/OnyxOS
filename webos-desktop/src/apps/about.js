...
const capabilities = [
  ...
  },
  {
    tag: "PLAY",
    title: "Games Library",
    desc: "3000+ games via Onyx Steam integration, Flash (Ruffle), DOS (JS-DOS), and console emulation."
  },
  {
    tag: "APPS",
...
const privacyText = `
  OnyxOS collects limited anonymous analytics to help improve stability and usage insights.
  ...
  OnyxOS does not sell user data or share it with advertisers.
`;

const copyrightText = `
  Copyright & Takedown Requests

  OnyxOS doesn't host any copyrighted content. Games and apps are loaded from their original sources or CDNs.
...
export class AboutApp extends BaseApp {
  ...
  open(opts = {}) {
    const win = os.window.create("about-yukios", "About OnyxOS", "720px", "85vh", {
      ...
      <div class="abx">
        <div class="abx-shell">
          ...
          <div class="abx-top">
            ...
            <div class="abx-meta">
              ...
              <a
                ...
                target="blank"
                rel="noopener noreferrer"
                href="https://github.com/reeyuki/OnyxOS"
              >
          ...
          <div class="abx-grid">
            ...
            <div class="abx-panel">
              <div class="abx-panel-h">Support OnyxOS</div>
              <div class="abx-panel-b">
                <div class="abx-sponsor">
                  ...
                  <div class="abx-sponsor-content">
                    ...
                    <div class="abx-sponsor-desc">Help keep OnyxOS free and open source. Your support directly funds development.</div>
