...
export class RemoteHostApp extends BaseApp {
  ...
  async open(opts = {}) {
    ...
    const win = os.window.create(winId, "Onyx Remote Desktop", "860px", "620px", {
      icon: "fas fa-desktop",
      resizable: true,
      minWidth: 500,
      minHeight: 400
          ...
          <div class="landing-content">
            ...
            <div class="landing-steps">
              <div class="landing-step">
                ...
                <div class="step-desc">
                  <strong>Open OnyxOS on your home PC</strong>
        ...
        <div class="remote-main" id="remoteMain" style="display:none">
          ...
          <div class="tab-panel active" id="panel-connect">
            <div class="connect-screen" id="connectScreen">
              ...
              <h3>Connect to Onyx Remote Desktop</h3>
