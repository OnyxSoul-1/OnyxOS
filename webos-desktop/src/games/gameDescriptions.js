...
export const descriptionMap = {
  ...
  aboutApp: "Version numbers, developer credits, and the story behind OnyxOS.",
  ...
  browserApp: "Surf the web from inside your virtual desktop with the built-in Onyx Browser.",
  yukiDevTools: "Onyx Dev Tools loads IT Tools in a themed iframe and keeps it synced with OnyxOS CSS variables.",
  ...
  steamApp: "Your game library, wrapped in a Steam-style storefront interface built right into OnyxOS.",
  ...
  yukiCode: "A Monaco-powered code editor built into OnyxOS, based on the same engine that runs Visual Studio Code.",
  jsDosApp:
