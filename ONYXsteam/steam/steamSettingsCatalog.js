export const SETTINGS = {
  runOnStartup: { title: "Run on Startup", description: "Launch Onyx Steam when your computer starts", type: "toggle", panel: "account", default: false },
  startMinimized: { title: "Start Minimized", description: "Start Onyx Steam minimized to system tray", type: "toggle", panel: "account", default: false },
  ...
  enableStartupAnimation: { title: "Enable Startup Animation", description: "Show loading animation when Onyx Steam starts", type: "toggle", panel: "interface", default: true },
  deckBootAnimation: { title: "Deck Boot Video", description: "Play the fullscreen boot video when Onyx Deck starts", type: "toggle", panel: "interface", default: true },
  ...
  steamAudioEnabled: { title: "Steam Audio", description: "Play UI sound effects in Steam and Onyx Deck", type: "toggle", panel: "interface", default: true },
