...
export class QuickAccessPanel {
  ...
  renderHelp(bodyEl) {
    const items = [
      { icon: "fa-book-open", label: "OnyxOS Guide", app: "yukiOsGuideApp" },
      { icon: "fa-keyboard", label: "Shortcuts", app: "shortcutsApp" },
      { icon: "fa-info-circle", label: "About OnyxOS", app: "aboutApp" }
    ];
    const infoRows = [
      { icon: "fa-tag", label: "Version", value: `OnyxOS ${YUKIOS_VERSION}` },
